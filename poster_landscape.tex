...
%  background=shade-tb,
  ...
  Ond\v rej \v Cert\'\i k$^{1,2}$, Pavel Solin$^2$, John E. Pask$^1$
...
{\begin{minipage}{7em}
    \hfill
    \includegraphics[height=5.5em]{Nevada_N_4c}
\end{minipage}}
  }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   We compare several high-order \textbf{finite element (FE)} methods for
   solving the radial Schr\"odinger and Dirac equations, in particular,
   spectral FEM (uniform-$p$-FEM), $p$-FEM, $h$-FEM, and $hp$-FEM. All methods
   provide a robust way of calculating all eigenstates to machine precision.
   They differ in the rate of convergence and whether a good initial mesh is
   needed or not, as well as providing robust error control.
 }
...
in the calculation of the \textbf{equation of state (EOS) and opacity of
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{High-Order Methods}{name=hpfem,column=0,below=motivation,span=1,above=bottom}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\small
...
\begin{itemize}
\item \textbf{$h$-FEM} increases accuracy by decreasing $h$
\item \textbf{$p$-FEM} increases accuracy by increasing $p$
\item \textbf{$hp$-FEM} increases accuracy by refining both $h$ and $p$ simultaneously
\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \renewcommand{\section}[2]{\vskip 0.05em}
      ...
      \bibitem{romanowski}
        ...
        \newblock {\em Molecular Physics, 107: 13, 1339--1348 (2009)}.
      \bibitem{solin}
...
\item $hp$-FEM is the method of choice when little or no \textit{a priori}
information is available; however, in atomic-structure context, much is known
$\to$ high-order $p$-FEM can be superior in practice (due to practical
constraints on $hp$-FEM mesh --- further research is needed).
\item \textbf{Future}: Extend present Schr\"odinger formulations to Dirac
equation and self-consistent calculations.
%EOS and opacity of materials under extreme conditions.
\end{itemize}
  }%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\texttt{LLNL-POST-447636}:$\,$This work was performed under the auspices of the
U.S. Department of Energy by Lawrence Livermore National Laboratory under
Contract DE-AC52-07NA27344.
  }%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Meshes for Error $< 10^{-6}\rm\,Ha$}{name=meshes,column=3,span=1,below=silver,above=acknowledgment}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \tiny
\begin{multicols}{2}
\begin{tabular}{|l|l|l|}
...
$h$-FEM (U)       & 1.56 - 25     & 6    \\
un-$p$-FEM (L)    & 3.22 - 64.34  & 8    \\
$p$-FEM (L)       & 3.22 - 64.34  & 5-11 \\
$p$-FEM (U)       & 25            & 2-16 \\
...
un-$p$-FEM 50 (L) & 0.08 - 15.44   & 8  \\
un-$p$-FEM 4  (L) & 3.00 - 105.06  & 44 \\
