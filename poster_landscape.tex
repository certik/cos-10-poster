...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{hp-FEM}{name=hpfem,column=0,below=motivation,span=1,above=bottom}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
High polynomial adaptive finite element method\cite{solin} has many favorable
properties:
\begin{itemize}
\item exponential convergence (both smooth and singular solutions)
\item automatic adaptivity (no apriori knowledge about the mesh needed)
\item any boundary conditions, any geometry
\item error control
\end{itemize}
...
Plane waves need periodic BC, simple geometry. Finite element method is
promising for electronic structure calculations\cite{pask}.
  }
...
$$
This is a generalized eigenvalue problem of the form $A x = \lambda B x$.
The eigensolvers usually normalize eigenvectors as $x^T B x = \one$, which
automatically imposes the normalization
$\int_0^\infty \rho^2 R^2\d\rho = 1$.

Note that $\rho^2 R'(\rho) = 0$ for
$\rho=0$, so we set the whole boundary term $[\rho^2R'v]_0^a=0$, which allows
us to impose any Neumann or Dirichlet boundary conditions on the right end of
the domain.

}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Dirac Equation}{name=dirac,column=1,below=schroed,above=bottom,row=0}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$$
The normalization is $\int_0^\infty P^2 + Q^2\d\rho = 1$.
  }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Conclusions}{name=questions,column=2,span=1,above=bottom,below=silver}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
$hp$-FEM is excellent if you don't know the mesh.
In practice however there are two constrains of the $hp$-adaptivity algorithm:
\begin{itemize}
\item the result very strongly depends on the initial mesh
\item it can only bisect
\end{itemize}
which can lead to non-optimal meshes (needs further research).
$p$-FEM is an improvement over uniform $p$-FEM as it must.
$hp$-FEM seems to converge better from a uniform initial mesh.
  }%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
