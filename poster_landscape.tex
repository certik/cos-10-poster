...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
High polynomial adaptive finite element method\cite{solin} has many favourable
properties:
\begin{itemize}
...
Plane waves (PW) are pseudospectral method, subset of spectral element method
(uniform $p$-FEM), which is a subset of $p$-FEM, which is a subset of $hp$-FEM.
...
$$
This is a generalized eigenvalue problem of the form $A x = \lambda B x$. Note that $\rho^2 R'(\rho) = 0$ for
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
p-FEM vs hp-FEM and uniform p-FEM vs p-FEM\\
    \includegraphics[height=0.25\textheight]{silver_eigenvalues}
    \includegraphics[height=0.25\textheight]{romanowski-vs-pfem}
  }%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Normalization}{name=questions,column=2,span=1,above=bottom,below=silver}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
The normalization of the radial Schr\"odinger equation is automatically imposed
by the eigensolver due to $x^T B x = \one$:
$$
\int_0^\infty \rho^2 R^2\d\rho = 1
$$
For the radial Dirac equation the normalization is:
$$
\int_0^\infty P^2 + Q^2\d\rho = 1
$$
  }%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
