...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\smaller
High-order adaptive FE methods provide a \textbf{robust,
...
High-order $p$-FEM and $hp$-FEM are \textbf{superior to $h$-FEM in atomic structure context}.
...
Future: extend present Schr\"odinger formulations to Dirac equation and
