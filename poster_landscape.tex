...
available; however, in atomic-structure context, much is known --> other
methods can be superior in practice (due to practical constraints on $hp$-FEM
mesh --- further research is needed).

Future: extend present Schroedinger formulations to Dirac equation and self-consistent calculations.
  }%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
